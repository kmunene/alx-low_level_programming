...
int main(void)
{
	...
	for (tensDigit1 = 0; tensDigit1 < 10; tensDigit1++)
	{
		...
		{
			for (tensDigit2 = 0; tensDigit2 < 10; tensDigit2++)
			{
				for (onesDigit2 = 0; onesDigit2 < 10; onesDigit2++)
				{
					if (tensDigit1 < tensDigit2 || (tensDigit1 == tensDigit2 && onesDigit1 < onesDigit2))
					{
